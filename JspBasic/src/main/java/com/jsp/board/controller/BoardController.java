...
import com.jsp.board.search.SearchService;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "list":
			...
			/*
			 ...
			 request 객체에 list 를 담아서 전달하려 하는데, sendRedirect 를 사용하면
			 응답이 바로 나가면서 기존의 request 객체가 소멸해 버립니다.
			 여기서는 forward 방식을 사용해서 request 를 원하는 jsp 파일로 전달해서
...
//			response.sendRedirect("board/board_list.jsp");
		...
		case "search":
			...
			System.out.println("글 search 요청이 들어옴! ");
