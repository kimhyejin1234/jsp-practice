...
//		
//		//응답하고자 하는 content 의 타입과 문자 
//		response.setContentType("text/html");
//		response.setCharacterEncoding("UTF-8");
//		
//		//응답 화면 제작
//		//자바 클래스에서 브라우저로 바로 응답 구현하기 위해서는
...
//                + "</html>";
//		
//		out.write(htmlCode);//버퍼에 응답하고자 하는 데이터 작성하기
//		out.flush();//버퍼를 비우면서 작성한 내용을 브라우저로 밀어내지
//		out.close();//객체 해제
//		
//	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//매개값으로 내장객체 request 와 response 가 전달 되므로
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//post 방식으로 요청이 들어 왔을 때, 함께 전송된 파라미터를 얻으실 때는
		//인토딩 작업을 다시 거치셔야 합니다.
	...
	@Override
	public void destroy() {
		// 서블릿 객체가 소멸될 때 호출되는 메서드(겍체 소멸시 1회 자동으로 호출)
		// 대부분 객체 반납이나 소명들에 사용.
